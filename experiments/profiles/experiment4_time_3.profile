::> PART 3.4.1: PERMUTERM INDEX
         23869367 function calls (23869351 primitive calls) in 6.316 seconds
   ...
   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
     ...
     4276    0.004    0.000    0.009    0.000 <frozen codecs>:319(decode)
      ...
      3/1    0.000    0.000    0.003    0.003 <frozen importlib._bootstrap>:666(_load_unlocked)
        ...
        2    0.000    0.000    0.001    0.001 <frozen importlib._bootstrap_external>:1007(get_code)
     ...
     1915    0.003    0.000    0.008    0.000 __init__.py:2140(info)
        ...
        1    0.020    0.020    6.307    6.307 experiment4.py:148(permuterm_trial)
        1    0.400    0.400    1.052    1.052 experiment4.py:55(generate_permuterm_indices)
       30    2.923    0.097    5.210    0.174 experiment4.py:72(permuterm_search_on_one_term)
        1    0.001    0.001    5.235    5.235 experiment4.py:86(permuterm_search_on_all_terms)
        1    0.000    0.000    0.000    0.000 functools.py:393(__get__)
        1    0.393    0.393    0.647    0.647 main.py:133(load_index_in_memory)
       ...
       32    0.000    0.000    0.008    0.000 std.py:1150(__str__)
       ...
       31    0.000    0.000    0.017    0.001 std.py:1160(__iter__)
       30    0.001    0.000    0.016    0.001 std.py:1198(update)
       ...
       31    0.000    0.000    0.015    0.000 std.py:1325(refresh)
       32    0.000    0.000    0.000    0.000 std.py:1446(format_dict)
       32    0.000    0.000    0.015    0.000 std.py:1464(display)
      ...
      181    0.000    0.000    0.000    0.000 std.py:231(__call__)
       ...
       32    0.000    0.000    0.005    0.000 std.py:451(fp_write)
       32    0.000    0.000    0.007    0.000 std.py:457(print_status)
       ...
       66    0.000    0.000    0.005    0.000 utils.py:194(inner)
     ...
     9390    0.002    0.000    0.003    0.000 utils.py:375(<genexpr>)
       96    0.000    0.000    0.005    0.000 utils.py:378(disp_len)
     ...
     4276    0.006    0.000    0.006    0.000 {built-in method _codecs.utf_8_decode}
      ...
      3/1    0.000    0.000    6.316    6.316 {built-in method builtins.exec}
   ...
   149510    0.010    0.000    0.010    0.000 {built-in method builtins.len}
      ...
      672    0.000    0.000    0.000    0.000 {built-in method builtins.ord}
       ...
       31    0.001    0.000    0.001    0.000 {built-in method now}
     ...
     9294    0.001    0.000    0.001    0.000 {built-in method unicodedata.east_asian_width}
        1    0.000    0.000    0.000    0.000 {function Random.seed at 0x7f6b59898220}
   ...
   830288    0.055    0.000    0.055    0.000 {method 'append' of 'list' objects}
    ...
    73759    0.132    0.000    0.132    0.000 {method 'split' of 'str' objects}
 21948816    2.280    0.000    2.280    0.000 {method 'startswith' of 'str' objects}
   830284    0.052    0.000    0.052    0.000 {method 'strip' of 'str' objects}
       96    0.000    0.000    0.000    0.000 {method 'sub' of 're.Pattern' objects}
       32    0.000    0.000    0.000    0.000 {method 'update' of 'dict' objects}
       34    0.005    0.000    0.005    0.000 {method 'write' of '_io.TextIOWrapper' objects}


::> PART 3.4.2: TREE BASED INDEX
         5904874 function calls (3236523 primitive calls) in 3.349 seconds
   ...
   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
     ...
     4276    0.003    0.000    0.008    0.000 <frozen codecs>:319(decode)
        1    0.082    0.082    3.349    3.349 <string>:1(<module>)
     ...
     1915    0.001    0.000    0.002    0.000 __init__.py:2140(info)
        ...
        1    0.000    0.000    0.000    0.000 decoder.py:332(decode)
        1    0.000    0.000    0.000    0.000 decoder.py:343(raw_decode)
        1    0.068    0.068    1.576    1.576 experiment4.py:121(tree_based_search)
       30    0.043    0.001    0.043    0.001 experiment4.py:138(<listcomp>)
        1    0.015    0.015    3.267    3.267 experiment4.py:153(trie_trial)
        2    0.000    0.000    0.000    0.000 experiment4.py:16(__init__)
   147518    0.369    0.000    1.065    0.000 experiment4.py:19(insert)
       60    0.000    0.000    1.458    0.024 experiment4.py:35(starts_with)
2668411/60    1.413    0.000    1.458    0.024 experiment4.py:47(dfs)
   516813    0.697    0.000    0.697    0.000 experiment4.py:9(__init__)
        1    0.037    0.037    1.676    1.676 experiment4.py:97(generate_trie_indices)
        1    0.000    0.000    0.000    0.000 functools.py:393(__get__)
        1    0.369    0.369    0.573    0.573 main.py:133(load_index_in_memory)
       13    0.000    0.000    0.000    0.000 std.py:102(acquire)
       13    0.000    0.000    0.000    0.000 std.py:106(release)
        4    0.000    0.000    0.000    0.000 std.py:110(__enter__)
        4    0.000    0.000    0.000    0.000 std.py:113(__exit__)
        1    0.000    0.000    0.000    0.000 std.py:1147(__del__)
       10    0.000    0.000    0.002    0.000 std.py:1150(__str__)
        2    0.000    0.000    0.000    0.000 std.py:1153(_comparable)
        2    0.000    0.000    0.000    0.000 std.py:1157(__hash__)
       31    0.000    0.000    0.004    0.000 std.py:1160(__iter__)
        8    0.000    0.000    0.003    0.000 std.py:1198(update)
        2    0.000    0.000    0.000    0.000 std.py:1265(close)
        2    0.000    0.000    0.000    0.000 std.py:1286(fp_write)
        1    0.000    0.000    0.000    0.000 std.py:1301(<lambda>)
        9    0.000    0.000    0.003    0.000 std.py:1325(refresh)
       10    0.000    0.000    0.000    0.000 std.py:1446(format_dict)
       10    0.000    0.000    0.003    0.000 std.py:1464(display)
       10    0.000    0.000    0.000    0.000 std.py:153(__init__)
       10    0.000    0.000    0.000    0.000 std.py:163(colour)
       10    0.000    0.000    0.000    0.000 std.py:167(colour)
       10    0.000    0.000    0.000    0.000 std.py:186(__format__)
        3    0.000    0.000    0.000    0.000 std.py:226(__init__)
       49    0.000    0.000    0.000    0.000 std.py:231(__call__)
       19    0.000    0.000    0.000    0.000 std.py:400(format_interval)
        1    0.000    0.000    0.000    0.000 std.py:438(status_printer)
       10    0.000    0.000    0.001    0.000 std.py:451(fp_write)
       10    0.000    0.000    0.001    0.000 std.py:457(print_status)
       10    0.000    0.000    0.002    0.000 std.py:464(format_meter)
       ...
       10    0.000    0.000    0.000    0.000 utils.py:108(__init__)
       10    0.000    0.000    0.000    0.000 utils.py:112(__format__)
        1    0.000    0.000    0.000    0.000 utils.py:125(__eq__)
        2    0.000    0.000    0.000    0.000 utils.py:139(__getattr__)
        3    0.000    0.000    0.000    0.000 utils.py:152(wrapper_setattr)
        1    0.000    0.000    0.000    0.000 utils.py:156(__init__)
        2    0.000    0.000    0.000    0.000 utils.py:187(disable_on_exception)
       22    0.000    0.000    0.001    0.000 utils.py:194(inner)
        1    0.000    0.000    0.000    0.000 utils.py:213(__init__)
        2    0.000    0.000    0.000    0.000 utils.py:222(__eq__)
        1    0.000    0.000    0.000    0.000 utils.py:252(_is_utf)
        1    0.000    0.000    0.000    0.000 utils.py:266(_supports_unicode)
       20    0.000    0.000    0.000    0.000 utils.py:273(_is_ascii)
        1    0.000    0.000    0.000    0.000 utils.py:282(_screen_shape_wrapper)
        1    0.000    0.000    0.000    0.000 utils.py:333(_screen_shape_linux)
       30    0.000    0.000    0.001    0.000 utils.py:374(_text_width)
     2928    0.001    0.000    0.001    0.000 utils.py:375(<genexpr>)
       30    0.000    0.000    0.001    0.000 utils.py:378(disp_len)
       10    0.000    0.000    0.001    0.000 utils.py:386(disp_trim)
     ...
     4276    0.005    0.000    0.005    0.000 {built-in method _codecs.utf_8_decode}
       ...
       48    0.000    0.000    0.000    0.000 {built-in method builtins.divmod}
        1    0.000    0.000    3.349    3.349 {built-in method builtins.exec}
    ...
    75697    0.005    0.000    0.005    0.000 {built-in method builtins.len}
      ...
      210    0.000    0.000    0.000    0.000 {built-in method builtins.ord}
       ...
       47    0.000    0.000    0.000    0.000 {built-in method time.time}
     2898    0.000    0.000    0.000    0.000 {built-in method unicodedata.east_asian_width}
  ...
  1571043    0.096    0.000    0.096    0.000 {method 'append' of 'list' objects}
        1    0.000    0.000    0.000    0.000 {method 'difference' of 'set' objects}
        1    0.000    0.000    0.000    0.000 {method 'disable' of '_lsprof.Profiler' objects}
        1    0.000    0.000    0.000    0.000 {method 'encode' of 'str' objects}
        2    0.000    0.000    0.000    0.000 {method 'end' of 're.Match' objects}
       ...
       13    0.000    0.000    0.000    0.000 {method 'release' of '_thread.RLock' objects}
        3    0.000    0.000    0.000    0.000 {method 'remove' of 'set' objects}
    73819    0.090    0.000    0.090    0.000 {method 'split' of 'str' objects}
   ...
   830284    0.050    0.000    0.050    0.000 {method 'strip' of 'str' objects}
       ...
       12    0.001    0.000    0.001    0.000 {method 'write' of '_io.TextIOWrapper' objects}
