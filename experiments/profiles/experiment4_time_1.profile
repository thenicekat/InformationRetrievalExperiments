...
100%|██████████████████████████████████████████████████████████████████████████████████████████| 30/30 [00:04<00:00,  6.13it/s]
         23869367 function calls (23869351 primitive calls) in 5.882 seconds
   ...
   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
     ...
     4276    0.003    0.000    0.008    0.000 <frozen codecs>:319(decode)
      ...
      5/4    0.000    0.000    0.000    0.000 <frozen importlib._bootstrap>:1207(_handle_fromlist)
      ...
      8/2    0.000    0.000    0.001    0.001 <frozen importlib._bootstrap>:233(_call_with_frames_removed)
      ...
      3/1    0.000    0.000    0.001    0.001 <frozen importlib._bootstrap>:666(_load_unlocked)
     ...
     1915    0.003    0.000    0.004    0.000 __init__.py:2140(info)
        ...
        1    0.000    0.000    0.002    0.002 context.py:70(RLock)
        1    0.000    0.000    0.000    0.000 decoder.py:332(decode)
        1    0.000    0.000    0.000    0.000 decoder.py:343(raw_decode)
        1    0.013    0.013    5.872    5.872 experiment4.py:148(permuterm_trial)
        1    0.325    0.325    0.959    0.959 experiment4.py:55(generate_permuterm_indices)
       30    2.749    0.092    4.884    0.163 experiment4.py:72(permuterm_search_on_one_term)
        1    0.001    0.001    4.900    4.900 experiment4.py:86(permuterm_search_on_all_terms)
        1    0.000    0.000    0.000    0.000 functools.py:393(__get__)
        1    0.375    0.375    0.630    0.630 main.py:133(load_index_in_memory)
       ...
       32    0.000    0.000    0.007    0.000 std.py:1150(__str__)
        2    0.000    0.000    0.000    0.000 std.py:1153(_comparable)
        2    0.000    0.000    0.000    0.000 std.py:1157(__hash__)
        1    0.000    0.000    0.002    0.002 std.py:116(create_mp_lock)
       31    0.000    0.000    0.012    0.000 std.py:1160(__iter__)
       30    0.000    0.000    0.011    0.000 std.py:1198(update)
       ...
       31    0.000    0.000    0.011    0.000 std.py:1325(refresh)
       32    0.000    0.000    0.000    0.000 std.py:1446(format_dict)
       32    0.000    0.000    0.010    0.000 std.py:1464(display)
      ...
      181    0.000    0.000    0.000    0.000 std.py:231(__call__)
       63    0.000    0.000    0.000    0.000 std.py:400(format_interval)
        1    0.000    0.000    0.000    0.000 std.py:438(status_printer)
       32    0.000    0.000    0.002    0.000 std.py:451(fp_write)
       32    0.000    0.000    0.003    0.000 std.py:457(print_status)
       32    0.002    0.000    0.006    0.000 std.py:464(format_meter)
        ...
        1    0.000    0.000    0.002    0.002 std.py:760(get_lock)
        1    0.000    0.000    0.002    0.002 std.py:90(__init__)
       ...
       64    0.000    0.000    0.000    0.000 utils.py:273(_is_ascii)
        1    0.000    0.000    0.000    0.000 utils.py:282(_screen_shape_wrapper)
        1    0.000    0.000    0.000    0.000 utils.py:333(_screen_shape_linux)
       96    0.000    0.000    0.004    0.000 utils.py:374(_text_width)
     9390    0.002    0.000    0.003    0.000 utils.py:375(<genexpr>)
       96    0.000    0.000    0.004    0.000 utils.py:378(disp_len)
       32    0.000    0.000    0.002    0.000 utils.py:386(disp_trim)
        ...
        2    0.000    0.000    0.000    0.000 {built-in method __new__ of type object at 0x860f60}
     4276    0.005    0.000    0.005    0.000 {built-in method _codecs.utf_8_decode}
      ...
      3/1    0.000    0.000    5.882    5.882 {built-in method builtins.exec}
       31    0.000    0.000    0.000    0.000 {built-in method builtins.getattr}
       86    0.000    0.000    0.000    0.000 {built-in method builtins.hasattr}
        3    0.000    0.000    0.000    0.000 {built-in method builtins.id}
       83    0.000    0.000    0.000    0.000 {built-in method builtins.isinstance}
   149510    0.009    0.000    0.009    0.000 {built-in method builtins.len}
        1    0.000    0.000    0.000    0.000 {built-in method builtins.locals}
       68    0.000    0.000    0.000    0.000 {built-in method builtins.max}
        1    0.000    0.000    0.000    0.000 {built-in method builtins.min}
        2    0.000    0.000    0.000    0.000 {built-in method builtins.next}
      672    0.000    0.000    0.000    0.000 {built-in method builtins.ord}
        2    0.000    0.000    0.000    0.000 {built-in method builtins.setattr}
       96    0.001    0.000    0.004    0.000 {built-in method builtins.sum}
      ...
      122    0.000    0.000    0.000    0.000 {built-in method time.time}
     9294    0.001    0.000    0.001    0.000 {built-in method unicodedata.east_asian_width}
        1    0.000    0.000    0.000    0.000 {function Random.seed at 0x7fd966374220}
   ...
   830288    0.052    0.000    0.052    0.000 {method 'append' of 'list' objects}
    ...
    73759    0.143    0.000    0.143    0.000 {method 'split' of 'str' objects}
 21948816    2.131    0.000    2.131    0.000 {method 'startswith' of 'str' objects}
   830284    0.048    0.000    0.048    0.000 {method 'strip' of 'str' objects}
       96    0.000    0.000    0.000    0.000 {method 'sub' of 're.Pattern' objects}
       32    0.000    0.000    0.000    0.000 {method 'update' of 'dict' objects}
       34    0.002    0.000    0.002    0.000 {method 'write' of '_io.TextIOWrapper' objects}


::> PART 3.4.2: TREE BASED INDEX
100%|██████████████████████████████████████████████████████████████████████████████████████████| 30/30 [00:01<00:00, 18.94it/s]
         5904202 function calls (3235851 primitive calls) in 3.301 seconds
   ...
   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
        ...
        2    0.000    0.000    0.000    0.000 <frozen codecs>:309(__init__)
     4276    0.003    0.000    0.008    0.000 <frozen codecs>:319(decode)
        1    0.073    0.073    3.301    3.301 <string>:1(<module>)
     1915    0.001    0.000    0.001    0.000 __init__.py:1479(info)
     1915    0.000    0.000    0.000    0.000 __init__.py:1734(isEnabledFor)
     1915    0.001    0.000    0.002    0.000 __init__.py:2140(info)
        1    0.000    0.000    0.000    0.000 __init__.py:274(load)
        1    0.000    0.000    0.000    0.000 __init__.py:299(loads)
        ...
        1    0.000    0.000    0.000    0.000 decoder.py:332(decode)
        1    0.000    0.000    0.000    0.000 decoder.py:343(raw_decode)
        1    0.073    0.073    1.585    1.585 experiment4.py:121(tree_based_search)
       30    0.044    0.001    0.044    0.001 experiment4.py:138(<listcomp>)
        1    0.016    0.016    3.228    3.228 experiment4.py:153(trie_trial)
        2    0.000    0.000    0.000    0.000 experiment4.py:16(__init__)
   147518    0.351    0.000    1.031    0.000 experiment4.py:19(insert)
       60    0.000    0.000    1.461    0.024 experiment4.py:35(starts_with)
2668411/60    1.418    0.000    1.461    0.024 experiment4.py:47(dfs)
   516813    0.680    0.000    0.680    0.000 experiment4.py:9(__init__)
        1    0.036    0.036    1.627    1.627 experiment4.py:97(generate_trie_indices)
        1    0.000    0.000    0.000    0.000 functools.py:393(__get__)
        1    0.364    0.364    0.560    0.560 main.py:133(load_index_in_memory)
       12    0.000    0.000    0.000    0.000 std.py:102(acquire)
       12    0.000    0.000    0.000    0.000 std.py:106(release)
        4    0.000    0.000    0.000    0.000 std.py:110(__enter__)
        4    0.000    0.000    0.000    0.000 std.py:113(__exit__)
        1    0.000    0.000    0.000    0.000 std.py:1147(__del__)
        9    0.000    0.000    0.002    0.000 std.py:1150(__str__)
        2    0.000    0.000    0.000    0.000 std.py:1153(_comparable)
        2    0.000    0.000    0.000    0.000 std.py:1157(__hash__)
       31    0.000    0.000    0.004    0.000 std.py:1160(__iter__)
        7    0.000    0.000    0.003    0.000 std.py:1198(update)
        2    0.000    0.000    0.000    0.000 std.py:1265(close)
        2    0.000    0.000    0.000    0.000 std.py:1286(fp_write)
        1    0.000    0.000    0.000    0.000 std.py:1301(<lambda>)
        8    0.000    0.000    0.003    0.000 std.py:1325(refresh)
        9    0.000    0.000    0.000    0.000 std.py:1446(format_dict)
        9    0.000    0.000    0.003    0.000 std.py:1464(display)
        9    0.000    0.000    0.000    0.000 std.py:153(__init__)
        9    0.000    0.000    0.000    0.000 std.py:163(colour)
        9    0.000    0.000    0.000    0.000 std.py:167(colour)
        9    0.000    0.000    0.000    0.000 std.py:186(__format__)
        3    0.000    0.000    0.000    0.000 std.py:226(__init__)
       43    0.000    0.000    0.000    0.000 std.py:231(__call__)
       17    0.000    0.000    0.000    0.000 std.py:400(format_interval)
        1    0.000    0.000    0.000    0.000 std.py:438(status_printer)
        9    0.000    0.000    0.001    0.000 std.py:451(fp_write)
        9    0.000    0.000    0.001    0.000 std.py:457(print_status)
        9    0.000    0.000    0.002    0.000 std.py:464(format_meter)
        ...
        9    0.000    0.000    0.000    0.000 utils.py:108(__init__)
        9    0.000    0.000    0.000    0.000 utils.py:112(__format__)
        1    0.000    0.000    0.000    0.000 utils.py:125(__eq__)
        2    0.000    0.000    0.000    0.000 utils.py:139(__getattr__)
        3    0.000    0.000    0.000    0.000 utils.py:152(wrapper_setattr)
        1    0.000    0.000    0.000    0.000 utils.py:156(__init__)
        2    0.000    0.000    0.000    0.000 utils.py:187(disable_on_exception)
       20    0.000    0.000    0.001    0.000 utils.py:194(inner)
        1    0.000    0.000    0.000    0.000 utils.py:213(__init__)
        2    0.000    0.000    0.000    0.000 utils.py:222(__eq__)
        1    0.000    0.000    0.000    0.000 utils.py:252(_is_utf)
        1    0.000    0.000    0.000    0.000 utils.py:266(_supports_unicode)
       18    0.000    0.000    0.000    0.000 utils.py:273(_is_ascii)
        1    0.000    0.000    0.000    0.000 utils.py:282(_screen_shape_wrapper)
        1    0.000    0.000    0.000    0.000 utils.py:333(_screen_shape_linux)
       27    0.000    0.000    0.001    0.000 utils.py:374(_text_width)
     2635    0.001    0.000    0.001    0.000 utils.py:375(<genexpr>)
       27    0.000    0.000    0.001    0.000 utils.py:378(disp_len)
        9    0.000    0.000    0.001    0.000 utils.py:386(disp_trim)
        1    0.000    0.000    0.000    0.000 {built-in method __new__ of type object at 0x860f60}
     4276    0.005    0.000    0.005    0.000 {built-in method _codecs.utf_8_decode}
        2    0.000    0.000    0.000    0.000 {built-in method _weakref.proxy}
       11    0.000    0.000    0.000    0.000 {built-in method builtins.abs}
       43    0.000    0.000    0.000    0.000 {built-in method builtins.divmod}
        1    0.000    0.000    3.301    3.301 {built-in method builtins.exec}
    ...
    75695    0.005    0.000    0.005    0.000 {built-in method builtins.len}
      ...
      189    0.000    0.000    0.000    0.000 {built-in method builtins.ord}
       27    0.000    0.000    0.001    0.000 {built-in method builtins.sum}
        ...
        1    0.000    0.000    0.000    0.000 {built-in method fromtimestamp}
        2    0.000    0.000    0.000    0.000 {built-in method io.open}
        8    0.000    0.000    0.000    0.000 {built-in method now}
       44    0.000    0.000    0.000    0.000 {built-in method time.time}
     2608    0.000    0.000    0.000    0.000 {built-in method unicodedata.east_asian_width}
        1    0.000    0.000    0.000    0.000 {method '__exit__' of '_io._IOBase' objects}
       12    0.000    0.000    0.000    0.000 {method 'acquire' of '_multiprocessing.SemLock' objects}
       12    0.000    0.000    0.000    0.000 {method 'acquire' of '_thread.RLock' objects}
        3    0.000    0.000    0.000    0.000 {method 'add' of 'set' objects}
  1571043    0.094    0.000    0.094    0.000 {method 'append' of 'list' objects}
        1    0.000    0.000    0.000    0.000 {method 'difference' of 'set' objects}
        1    0.000    0.000    0.000    0.000 {method 'disable' of '_lsprof.Profiler' objects}
        1    0.000    0.000    0.000    0.000 {method 'encode' of 'str' objects}
        2    0.000    0.000    0.000    0.000 {method 'end' of 're.Match' objects}
       ...
       30    0.001    0.000    0.001    0.000 {method 'intersection' of 'set' objects}
        ...
        1    0.000    0.000    0.000    0.000 {method 'read' of '_io.TextIOWrapper' objects}
       12    0.000    0.000    0.000    0.000 {method 'release' of '_multiprocessing.SemLock' objects}
       12    0.000    0.000    0.000    0.000 {method 'release' of '_thread.RLock' objects}
        3    0.000    0.000    0.000    0.000 {method 'remove' of 'set' objects}
    73819    0.082    0.000    0.082    0.000 {method 'split' of 'str' objects}
        1    0.000    0.000    0.000    0.000 {method 'startswith' of 'str' objects}
   830284    0.050    0.000    0.050    0.000 {method 'strip' of 'str' objects}
       27    0.000    0.000    0.000    0.000 {method 'sub' of 're.Pattern' objects}
        9    0.000    0.000    0.000    0.000 {method 'update' of 'dict' objects}
       11    0.001    0.000    0.001    0.000 {method 'write' of '_io.TextIOWrapper' objects}
