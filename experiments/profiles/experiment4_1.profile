...
=============================================================
   156     69.0 MiB     69.0 MiB           1   @memory_profile
   157                                         def permuterm_trial():
   158    167.0 MiB     98.0 MiB           1       postings, term_freq = load_index_in_memory("./s2/")
   159                                             # Here postings is the inverted index
   160                                             # term_freq is the term frequency of each term in the collection
   161    244.9 MiB     78.0 MiB           1       permuterm_index = generate_permuterm_indices(term_freq=term_freq)
   162    245.2 MiB      0.2 MiB           1       permuterm_search_on_all_terms(permuterm_index, postings)


         24028208 function calls (24027059 primitive calls) in 25.364 seconds
   ...
   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
     ...
     4279    0.018    0.000    0.027    0.000 <frozen codecs>:319(decode)
     ...
     1551    0.001    0.000    0.006    0.000 <frozen posixpath>:397(abspath)
     8716    0.003    0.000    0.004    0.000 <frozen posixpath>:41(_get_sep)
      775    0.001    0.000    0.042    0.000 <frozen posixpath>:412(realpath)
      775    0.010    0.000    0.038    0.000 <frozen posixpath>:421(_joinrealpath)
     1016    0.001    0.000    0.001    0.000 <frozen posixpath>:52(normcase)
     2326    0.002    0.000    0.004    0.000 <frozen posixpath>:60(isabs)
     6330    0.009    0.000    0.015    0.000 <frozen posixpath>:71(join)
       42    0.000    0.000    0.000    0.000 <string>:1(<lambda>)
        1    0.000    0.000   25.364   25.364 <string>:1(<module>)
       60    0.001    0.000    0.006    0.000 __init__.py:1087(flush)
       60    0.001    0.000    0.010    0.000 __init__.py:1098(emit)
       60    0.000    0.000    0.010    0.000 __init__.py:1216(emit)
       60    0.000    0.000    0.000    0.000 __init__.py:123(getLevelName)
        1    0.000    0.000    0.000    0.000 __init__.py:1319(disable)
       60    0.001    0.000    0.023    0.000 __init__.py:1479(info)
       60    0.001    0.000    0.003    0.000 __init__.py:1561(findCaller)
       60    0.001    0.000    0.006    0.000 __init__.py:1595(makeRecord)
       60    0.001    0.000    0.022    0.000 __init__.py:1610(_log)
      ...
      240    0.001    0.000    0.001    0.000 __init__.py:194(_is_internal_frame)
       60    0.001    0.000    0.024    0.000 __init__.py:2140(info)
       ...
       60    0.003    0.000    0.005    0.000 __init__.py:292(__init__)
      ...
      120    0.000    0.000    0.000    0.000 __init__.py:929(release)
       ...
       60    0.001    0.000    0.011    0.000 __init__.py:965(handle)
   ...
   306/29    0.001    0.000    0.001    0.000 _parser.py:174(getwidth)
     ...
     52/2    0.000    0.000    0.006    0.003 _parser.py:449(_parse_sub)
    221/5    0.002    0.000    0.005    0.001 _parser.py:509(_parse)
       ...
       26    0.000    0.000    0.001    0.000 _parser.py:94(closegroup)
        ...
        1    0.001    0.001   25.250   25.250 experiment4.py:156(permuterm_trial)
        1    0.942    0.942    0.948    0.948 experiment4.py:55(generate_permuterm_indices)
       30   18.629    0.621   22.480    0.749 experiment4.py:69(permuterm_search_on_one_term)
        1    0.003    0.003   22.542   22.542 experiment4.py:88(permuterm_search_on_all_terms)
        1    0.000    0.000    0.000    0.000 functools.py:393(__get__)
        1    0.000    0.000    0.000    0.000 functools.py:421(_unwrap_partial)
        1    0.000    0.000    0.060    0.060 inspect.py:1055(findsource)
       ...
       42    0.000    0.000    0.000    0.000 inspect.py:1181(tokeneater)
        ...
        1    0.000    0.000    0.068    0.068 inspect.py:1235(getsourcelines)
     ...
     3008    0.001    0.000    0.001    0.000 inspect.py:946(<genexpr>)
      776    0.001    0.000    0.013    0.000 inspect.py:961(getabsfile)
        1    0.002    0.002    0.059    0.059 inspect.py:973(getmodule)
        ...
        1    1.412    1.412    1.759    1.759 main.py:133(load_index_in_memory)
        1    0.000    0.000   25.364   25.364 memory_profiler.py:1185(wrapper)
        ...
        1    0.000    0.000    0.068    0.068 memory_profiler.py:645(add)
        ...
        1    0.000    0.000    0.068    0.068 memory_profiler.py:713(__call__)
        1    0.000    0.000    0.068    0.068 memory_profiler.py:728(add_function)
        ...
        1    0.046    0.046   25.296   25.296 memory_profiler.py:759(f)
       ...
       31    0.000    0.000    0.028    0.001 std.py:1160(__iter__)
       30    0.001    0.000    0.027    0.001 std.py:1198(update)
       ...
       31    0.000    0.000    0.026    0.001 std.py:1325(refresh)
       32    0.000    0.000    0.001    0.000 std.py:1446(format_dict)
       32    0.000    0.000    0.026    0.001 std.py:1464(display)
      ...
      181    0.001    0.000    0.001    0.000 std.py:231(__call__)
       ...
       32    0.000    0.000    0.002    0.000 std.py:451(fp_write)
       32    0.000    0.000    0.008    0.000 std.py:457(print_status)
       32    0.005    0.000    0.016    0.001 std.py:464(format_meter)
        1    0.000    0.000    0.006    0.006 std.py:663(__new__)
        ...
        1    0.000    0.000    0.001    0.001 synchronize.py:191(__init__)
      ...
      4/2    0.000    0.000    0.000    0.000 typing.py:3350(__getattribute__)
       ...
       96    0.000    0.000    0.013    0.000 utils.py:374(_text_width)
     9390    0.008    0.000    0.009    0.000 utils.py:375(<genexpr>)
       96    0.000    0.000    0.014    0.000 utils.py:378(disp_len)
     ...
     1552    0.001    0.000    0.003    0.000 {built-in method builtins.any}
      158    0.000    0.000    0.000    0.000 {built-in method builtins.divmod}
      3/1    0.000    0.000   25.364   25.364 {built-in method builtins.exec}
...
150097/149787    0.014    0.000    0.014    0.000 {built-in method builtins.len}
     ...
     1062    0.000    0.000    0.000    0.000 {built-in method builtins.ord}
       ...
       96    0.004    0.000    0.013    0.000 {built-in method builtins.sum}
    ...
    13676    0.002    0.000    0.002    0.000 {built-in method posix.fspath}
     ...
     6330    0.009    0.000    0.009    0.000 {built-in method posix.lstat}
     ...
     9294    0.001    0.000    0.001    0.000 {built-in method unicodedata.east_asian_width}
        1    0.000    0.000    0.000    0.000 {function Random.seed at 0x7f2da4901580}
    ...
    43393    0.010    0.000    0.010    0.000 {method 'add' of 'set' objects}
        1    0.000    0.000    0.000    0.000 {method 'append' of 'collections.deque' objects}
   833406    0.076    0.000    0.076    0.000 {method 'append' of 'list' objects}
    ...
    10120    0.002    0.000    0.002    0.000 {method 'endswith' of 'str' objects}
      ...
      201    0.000    0.000    0.000    0.000 {method 'find' of 'bytearray' objects}
       ...
       83    0.000    0.000    0.001    0.000 {method 'format' of 'str' objects}
    ...
    73759    0.161    0.000    0.161    0.000 {method 'split' of 'str' objects}
        1    0.000    0.000    0.000    0.000 {method 'startswith' of 'bytes' objects}
 21957473    3.843    0.000    3.843    0.000 {method 'startswith' of 'str' objects}
   830284    0.075    0.000    0.075    0.000 {method 'strip' of 'str' objects}
...
Line #    Mem usage    Increment  Occurrences   Line Contents
=============================================================
   165     86.2 MiB     86.2 MiB           1   @memory_profile
   166                                         def trie_trial():
   167    167.9 MiB     81.7 MiB           1       postings, term_freq = load_index_in_memory("./s2/")
   168                                             # Here postings is the inverted index
   169                                             # term_freq is the term frequency of each term in the collection
   170    296.8 MiB    128.9 MiB           2       trieBasedIndexFromStart, trieBasedIndexFromEnd = generate_trie_indices(
   171    167.9 MiB      0.0 MiB           1           term_freq=term_freq
   172                                             )
   173    304.6 MiB      7.7 MiB           2       tree_based_search(
   174    296.8 MiB      0.0 MiB           1           start_trie=trieBasedIndexFromStart,
   175    296.8 MiB      0.0 MiB           1           end_trie=trieBasedIndexFromEnd,
   176    296.8 MiB      0.0 MiB           1           postings=postings,
   177                                             )


         5949878 function calls (3281527 primitive calls) in 14.397 seconds
   ...
   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
     ...
     4276    0.016    0.000    0.025    0.000 <frozen codecs>:319(decode)
       60    0.000    0.000    0.000    0.000 <frozen genericpath>:121(_splitext)
      ...
      240    0.000    0.000    0.000    0.000 <frozen posixpath>:52(normcase)
       61    0.000    0.000    0.000    0.000 <string>:1(<lambda>)
        1    0.000    0.000   14.397   14.397 <string>:1(<module>)
       60    0.001    0.000    0.006    0.000 __init__.py:1087(flush)
       60    0.001    0.000    0.010    0.000 __init__.py:1098(emit)
       60    0.000    0.000    0.011    0.000 __init__.py:1216(emit)
       60    0.000    0.000    0.000    0.000 __init__.py:123(getLevelName)
       60    0.001    0.000    0.024    0.000 __init__.py:1479(info)
       60    0.001    0.000    0.003    0.000 __init__.py:1561(findCaller)
       60    0.001    0.000    0.006    0.000 __init__.py:1595(makeRecord)
       60    0.001    0.000    0.023    0.000 __init__.py:1610(_log)
       60    0.000    0.000    0.013    0.000 __init__.py:1636(handle)
       60    0.000    0.000    0.000    0.000 __init__.py:164(<lambda>)
      ...
      120    0.000    0.000    0.000    0.000 __init__.py:929(release)
       ...
       60    0.001    0.000    0.012    0.000 __init__.py:965(handle)
        ...
        1    0.000    0.000    0.000    0.000 decoder.py:332(decode)
        1    0.000    0.000    0.000    0.000 decoder.py:343(raw_decode)
        1    0.197    0.197    3.936    3.936 experiment4.py:103(generate_trie_indices)
        1    0.180    0.180    8.469    8.469 experiment4.py:126(tree_based_search)
       30    0.236    0.008    0.236    0.008 experiment4.py:143(<listcomp>)
        2    0.000    0.000    0.000    0.000 experiment4.py:16(__init__)
        1    0.001    0.001   14.236   14.236 experiment4.py:165(trie_trial)
   147518    2.153    0.000    3.739    0.000 experiment4.py:19(insert)
       60    0.001    0.000    8.005    0.133 experiment4.py:35(starts_with)
2668411/60    7.932    0.000    8.004    0.133 experiment4.py:47(dfs)
   516813    1.586    0.000    1.586    0.000 experiment4.py:9(__init__)
        1    0.000    0.000    0.000    0.000 functools.py:393(__get__)
        1    0.000    0.000    0.000    0.000 functools.py:421(_unwrap_partial)
       ...
       61    0.000    0.000    0.000    0.000 inspect.py:1181(tokeneater)
        ...
        2    0.000    0.000    0.000    0.000 linecache.py:36(getlines)
        1    0.000    0.000    0.000    0.000 linecache.py:52(checkcache)
        1    1.506    1.506    1.830    1.830 main.py:133(load_index_in_memory)
        1    0.000    0.000   14.397   14.397 memory_profiler.py:1185(wrapper)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:1201(choose_backend)
        6    0.000    0.000    0.000    0.000 memory_profiler.py:1215(<genexpr>)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:640(__init__)
       ...
       14    0.000    0.000    0.000    0.000 memory_profiler.py:695(<genexpr>)
        ...
        2    0.000    0.000    0.000    0.000 memory_profiler.py:740(_count_ctxmgr)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:748(wrap_function)
        1    0.160    0.160   14.396   14.396 memory_profiler.py:759(f)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:775(enable_by_count)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:782(disable_by_count)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:842(enable)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:849(disable)
       ...
       19    0.000    0.000    0.000    0.000 std.py:106(release)
        ...
        4    0.000    0.000    0.000    0.000 std.py:113(__exit__)
        1    0.000    0.000    0.000    0.000 std.py:1147(__del__)
       16    0.000    0.000    0.008    0.001 std.py:1150(__str__)
        2    0.000    0.000    0.000    0.000 std.py:1153(_comparable)
        2    0.000    0.000    0.000    0.000 std.py:1157(__hash__)
       31    0.000    0.000    0.014    0.000 std.py:1160(__iter__)
       14    0.000    0.000    0.013    0.001 std.py:1198(update)
        2    0.000    0.000    0.001    0.000 std.py:1265(close)
        2    0.000    0.000    0.000    0.000 std.py:1286(fp_write)
        1    0.000    0.000    0.000    0.000 std.py:1301(<lambda>)
       15    0.000    0.000    0.013    0.001 std.py:1325(refresh)
       16    0.000    0.000    0.000    0.000 std.py:1446(format_dict)
       16    0.000    0.000    0.013    0.001 std.py:1464(display)
       ...
       16    0.000    0.000    0.004    0.000 std.py:457(print_status)
       16    0.002    0.000    0.008    0.000 std.py:464(format_meter)
       ...
       34    0.000    0.000    0.001    0.000 utils.py:194(inner)
        ...
        1    0.000    0.000    0.000    0.000 utils.py:252(_is_utf)
        1    0.000    0.000    0.000    0.000 utils.py:266(_supports_unicode)
       32    0.000    0.000    0.000    0.000 utils.py:273(_is_ascii)
        1    0.000    0.000    0.000    0.000 utils.py:282(_screen_shape_wrapper)
        1    0.000    0.000    0.000    0.000 utils.py:333(_screen_shape_linux)
       48    0.000    0.000    0.007    0.000 utils.py:374(_text_width)
     4690    0.004    0.000    0.005    0.000 utils.py:375(<genexpr>)
       48    0.000    0.000    0.007    0.000 utils.py:378(disp_len)
       16    0.000    0.000    0.003    0.000 utils.py:386(disp_trim)
     ...
     4276    0.009    0.000    0.009    0.000 {built-in method _codecs.utf_8_decode}
      120    0.000    0.000    0.000    0.000 {built-in method _thread.get_ident}
       ...
       78    0.000    0.000    0.000    0.000 {built-in method builtins.divmod}
        1    0.000    0.000   14.397   14.397 {built-in method builtins.exec}
    ...
    73917    0.009    0.000    0.009    0.000 {built-in method builtins.len}
      ...
      336    0.000    0.000    0.000    0.000 {built-in method builtins.ord}
       48    0.002    0.000    0.007    0.000 {built-in method builtins.sum}
        1    0.000    0.000    0.000    0.000 {built-in method fcntl.ioctl}
        1    0.000    0.000    0.000    0.000 {built-in method fromtimestamp}
  ...
  1571045    0.154    0.000    0.154    0.000 {method 'append' of 'list' objects}
        1    0.000    0.000    0.000    0.000 {method 'difference' of 'set' objects}
        1    0.000    0.000    0.000    0.000 {method 'disable' of '_lsprof.Profiler' objects}
        1    0.000    0.000    0.000    0.000 {method 'encode' of 'str' objects}
        2    0.000    0.000    0.000    0.000 {method 'end' of 're.Match' objects}
    ...
    73819    0.128    0.000    0.128    0.000 {method 'split' of 'str' objects}
        1    0.000    0.000    0.000    0.000 {method 'startswith' of 'str' objects}
   830284    0.080    0.000    0.080    0.000 {method 'strip' of 'str' objects}
