...
=============================================================
    81     66.5 MiB     66.5 MiB           1   @memory_profile
    82                                         def helper_trie():
    83    221.8 MiB    155.3 MiB           1       trieBasedIndex = generate_trie_indices()
    84    221.8 MiB      0.0 MiB           1       tree_based_search(trieBasedIndex)


         2495929 function calls (2494780 primitive calls) in 2.579 seconds
   ...
   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
     ...
     4278    0.010    0.000    0.015    0.000 <frozen codecs>:319(decode)
      200    0.001    0.000    0.001    0.000 <frozen genericpath>:121(_splitext)
      728    0.000    0.000    0.002    0.000 <frozen genericpath>:16(exists)
      ...
      3/1    0.000    0.000    0.002    0.002 <frozen importlib._bootstrap>:1120(_find_and_load_unlocked)
      3/1    0.000    0.000    0.002    0.002 <frozen importlib._bootstrap>:1165(_find_and_load)
      ...
      3/1    0.000    0.000    0.002    0.002 <frozen importlib._bootstrap>:666(_load_unlocked)
        ...
        2    0.000    0.000    0.000    0.000 <frozen importlib._bootstrap_external>:1007(get_code)
      ...
      2/1    0.000    0.000    0.002    0.002 <frozen importlib._bootstrap_external>:934(exec_module)
      200    0.001    0.000    0.001    0.000 <frozen posixpath>:117(splitext)
      200    0.001    0.000    0.001    0.000 <frozen posixpath>:140(basename)
     1551    0.001    0.000    0.002    0.000 <frozen posixpath>:389(normpath)
     1551    0.001    0.000    0.016    0.000 <frozen posixpath>:397(abspath)
     8856    0.003    0.000    0.004    0.000 <frozen posixpath>:41(_get_sep)
      775    0.001    0.000    0.062    0.000 <frozen posixpath>:412(realpath)
      775    0.021    0.000    0.058    0.000 <frozen posixpath>:421(_joinrealpath)
     1576    0.001    0.000    0.001    0.000 <frozen posixpath>:52(normcase)
     2326    0.013    0.000    0.015    0.000 <frozen posixpath>:60(isabs)
     6330    0.012    0.000    0.018    0.000 <frozen posixpath>:71(join)
       26    0.000    0.000    0.000    0.000 <string>:1(<lambda>)
        1    0.000    0.000    2.579    2.579 <string>:1(<module>)
      200    0.001    0.000    0.007    0.000 __init__.py:1087(flush)
      200    0.001    0.000    0.013    0.000 __init__.py:1098(emit)
      200    0.001    0.000    0.014    0.000 __init__.py:1216(emit)
      200    0.000    0.000    0.000    0.000 __init__.py:123(getLevelName)
        1    0.000    0.000    0.000    0.000 __init__.py:1319(disable)
      200    0.001    0.000    0.035    0.000 __init__.py:1479(info)
      200    0.002    0.000    0.005    0.000 __init__.py:1561(findCaller)
      200    0.001    0.000    0.010    0.000 __init__.py:1595(makeRecord)
      200    0.002    0.000    0.034    0.000 __init__.py:1610(_log)
      200    0.001    0.000    0.018    0.000 __init__.py:1636(handle)
      200    0.000    0.000    0.000    0.000 __init__.py:164(<lambda>)
      200    0.001    0.000    0.017    0.000 __init__.py:1690(callHandlers)
        1    0.000    0.000    0.000    0.000 __init__.py:1720(getEffectiveLevel)
      200    0.000    0.000    0.000    0.000 __init__.py:1734(isEnabledFor)
      800    0.001    0.000    0.002    0.000 __init__.py:194(_is_internal_frame)
      200    0.001    0.000    0.036    0.000 __init__.py:2140(info)
        2    0.000    0.000    0.012    0.006 __init__.py:225(compile)
        1    0.000    0.000    0.000    0.000 __init__.py:228(_acquireLock)
        1    0.000    0.000    0.000    0.000 __init__.py:237(_releaseLock)
        2    0.000    0.000    0.012    0.006 __init__.py:272(_compile)
        1    0.000    0.000    0.000    0.000 __init__.py:274(load)
      200    0.005    0.000    0.009    0.000 __init__.py:292(__init__)
        1    0.000    0.000    0.000    0.000 __init__.py:299(loads)
      200    0.000    0.000    0.000    0.000 __init__.py:368(getMessage)
      200    0.000    0.000    0.000    0.000 __init__.py:432(usesTime)
      200    0.001    0.000    0.001    0.000 __init__.py:440(_format)
      200    0.000    0.000    0.001    0.000 __init__.py:447(format)
      200    0.000    0.000    0.002    0.000 __init__.py:606(formatTime)
      200    0.000    0.000    0.001    0.000 __init__.py:652(usesTime)
      200    0.000    0.000    0.001    0.000 __init__.py:658(formatMessage)
      200    0.001    0.000    0.005    0.000 __init__.py:674(format)
      400    0.000    0.000    0.000    0.000 __init__.py:815(filter)
        3    0.000    0.000    0.000    0.000 __init__.py:89(find_spec)
      400    0.000    0.000    0.001    0.000 __init__.py:922(acquire)
      400    0.001    0.000    0.001    0.000 __init__.py:929(release)
      200    0.000    0.000    0.005    0.000 __init__.py:942(format)
        1    0.000    0.000    0.000    0.000 __init__.py:96(<lambda>)
      200    0.001    0.000    0.015    0.000 __init__.py:965(handle)
    ...
    280/2    0.001    0.000    0.003    0.002 _compiler.py:37(_compile)
       ...
       62    0.000    0.000    0.000    0.000 _compiler.py:396(_simple)
        ...
        2    0.000    0.000    0.012    0.006 _compiler.py:738(compile)
     ...
     1537    0.001    0.000    0.001    0.000 _parser.py:164(__getitem__)
      ...
      443    0.001    0.000    0.001    0.000 _parser.py:172(append)
   306/29    0.001    0.000    0.001    0.000 _parser.py:174(getwidth)
        2    0.000    0.000    0.000    0.000 _parser.py:224(__init__)
      949    0.001    0.000    0.001    0.000 _parser.py:233(__next)
      572    0.001    0.000    0.001    0.000 _parser.py:249(match)
     ...
     52/2    0.001    0.000    0.009    0.005 _parser.py:449(_parse_sub)
    221/5    0.003    0.000    0.009    0.002 _parser.py:509(_parse)
       ...
       26    0.000    0.000    0.001    0.000 _parser.py:94(closegroup)
        ...
        2    0.000    0.000    0.009    0.005 _parser.py:972(parse)
        ...
        1    0.000    0.000    0.000    0.000 experiment3.py:17(__init__)
    73759    0.593    0.000    1.048    0.000 experiment3.py:20(insert)
      231    0.003    0.000    0.003    0.000 experiment3.py:29(search)
      100    0.001    0.000    0.175    0.002 experiment3.py:39(boolean_retrieval_multiple_words)
        1    0.071    0.071    2.218    2.218 experiment3.py:53(generate_trie_indices)
        1    0.002    0.002    0.220    0.220 experiment3.py:68(tree_based_search)
        1    0.003    0.003    2.440    2.440 experiment3.py:81(helper_trie)
   232384    0.455    0.000    0.455    0.000 experiment3.py:9(__init__)
        1    0.000    0.000    0.000    0.000 functools.py:393(__get__)
        1    0.000    0.000    0.000    0.000 functools.py:421(_unwrap_partial)
        1    0.000    0.000    0.090    0.090 inspect.py:1055(findsource)
        1    0.000    0.000    0.000    0.000 inspect.py:1172(__init__)
       26    0.000    0.000    0.000    0.000 inspect.py:1181(tokeneater)
        1    0.000    0.000    0.012    0.012 inspect.py:1224(getblock)
        1    0.000    0.000    0.102    0.102 inspect.py:1235(getsourcelines)
     1636    0.001    0.000    0.001    0.000 inspect.py:283(ismodule)
        ...
        3    0.000    0.000    0.000    0.000 inspect.py:480(iscode)
      ...
      776    0.002    0.000    0.009    0.000 inspect.py:936(getsourcefile)
     2328    0.001    0.000    0.001    0.000 inspect.py:943(<genexpr>)
     3008    0.001    0.000    0.002    0.000 inspect.py:946(<genexpr>)
      776    0.001    0.000    0.023    0.000 inspect.py:961(getabsfile)
        1    0.002    0.002    0.089    0.089 inspect.py:973(getmodule)
        ...
        1    0.877    0.877    1.099    1.099 main.py:133(load_index_in_memory)
      130    0.156    0.001    0.171    0.001 main.py:155(intersection)
        1    0.000    0.000    2.579    2.579 memory_profiler.py:1185(wrapper)
        ...
        1    0.000    0.000    0.102    0.102 memory_profiler.py:645(add)
        2    0.000    0.000    0.000    0.000 memory_profiler.py:689(items)
        5    0.000    0.000    0.000    0.000 memory_profiler.py:695(<genexpr>)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:702(__init__)
        1    0.000    0.000    0.102    0.102 memory_profiler.py:713(__call__)
        1    0.000    0.000    0.102    0.102 memory_profiler.py:728(add_function)
        ...
        1    0.036    0.036    2.477    2.477 memory_profiler.py:759(f)
      ...
      201    0.000    0.000    0.000    0.000 process.py:37(current_process)
        ...
        7    0.000    0.000    0.000    0.000 std.py:102(acquire)
        7    0.000    0.000    0.000    0.000 std.py:106(release)
        ...
        4    0.000    0.000    0.002    0.000 std.py:1150(__str__)
        2    0.000    0.000    0.000    0.000 std.py:1153(_comparable)
        2    0.000    0.000    0.000    0.000 std.py:1157(__hash__)
        1    0.000    0.000    0.003    0.003 std.py:116(create_mp_lock)
      101    0.000    0.000    0.002    0.000 std.py:1160(__iter__)
        2    0.000    0.000    0.001    0.001 std.py:1198(update)
        ...
        3    0.000    0.000    0.002    0.001 std.py:1325(refresh)
        4    0.000    0.000    0.000    0.000 std.py:1446(format_dict)
        4    0.000    0.000    0.002    0.001 std.py:1464(display)
        4    0.000    0.000    0.000    0.000 std.py:153(__init__)
        4    0.000    0.000    0.000    0.000 std.py:163(colour)
        4    0.000    0.000    0.000    0.000 std.py:167(colour)
        4    0.000    0.000    0.000    0.000 std.py:186(__format__)
        3    0.000    0.000    0.000    0.000 std.py:226(__init__)
       13    0.000    0.000    0.000    0.000 std.py:231(__call__)
        7    0.000    0.000    0.000    0.000 std.py:400(format_interval)
        1    0.000    0.000    0.000    0.000 std.py:438(status_printer)
        4    0.000    0.000    0.000    0.000 std.py:451(fp_write)
        4    0.000    0.000    0.001    0.000 std.py:457(print_status)
        4    0.000    0.000    0.001    0.000 std.py:464(format_meter)
        1    0.000    0.000    0.003    0.003 std.py:663(__new__)
        ...
        1    0.000    0.000    0.003    0.003 std.py:760(get_lock)
        1    0.000    0.000    0.003    0.003 std.py:90(__init__)
      ...
      200    0.000    0.000    0.000    0.000 threading.py:1145(name)
      ...
      201    0.000    0.000    0.000    0.000 threading.py:1446(current_thread)
       ...
       27    0.000    0.000    0.012    0.000 tokenize.py:433(_tokenize)
        1    0.000    0.000    0.000    0.000 tokenize.py:616(generate_tokens)
        1    0.000    0.000    0.011    0.011 tokenize.py:99(_compile)
      4/2    0.000    0.000    0.000    0.000 typing.py:3350(__getattribute__)
        ...
        4    0.000    0.000    0.000    0.000 utils.py:108(__init__)
        4    0.000    0.000    0.000    0.000 utils.py:112(__format__)
       ...
       10    0.000    0.000    0.000    0.000 utils.py:194(inner)
        ...
        8    0.000    0.000    0.000    0.000 utils.py:273(_is_ascii)
     ...
     1175    0.001    0.000    0.001    0.000 utils.py:375(<genexpr>)
     ...
     4278    0.005    0.000    0.005    0.000 {built-in method _codecs.utf_8_decode}
     ...
     6330    0.001    0.000    0.001    0.000 {built-in method _stat.S_ISLNK}
      ...
      407    0.000    0.000    0.000    0.000 {built-in method _thread.get_ident}
     ...
     1552    0.001    0.000    0.004    0.000 {built-in method builtins.any}
       18    0.000    0.000    0.000    0.000 {built-in method builtins.divmod}
      3/1    0.000    0.000    2.579    2.579 {built-in method builtins.exec}
      858    0.000    0.000    0.000    0.000 {built-in method builtins.getattr}
     1239    0.001    0.000    0.001    0.000 {built-in method builtins.hasattr}
        4    0.000    0.000    0.000    0.000 {built-in method builtins.id}
    14619    0.002    0.000    0.002    0.000 {built-in method builtins.isinstance}
        1    0.000    0.000    0.000    0.000 {built-in method builtins.iter}
302360/302050    0.019    0.000    0.019    0.000 {built-in method builtins.len}
      ...
      474    0.000    0.000    0.000    0.000 {built-in method builtins.ord}
    ...
    14516    0.001    0.000    0.001    0.000 {built-in method posix.fspath}
      201    0.000    0.000    0.000    0.000 {built-in method posix.getpid}
     6330    0.013    0.000    0.013    0.000 {built-in method posix.lstat}
      ...
      200    0.001    0.000    0.001    0.000 {built-in method time.localtime}
      200    0.000    0.000    0.000    0.000 {built-in method time.strftime}
      256    0.000    0.000    0.000    0.000 {built-in method time.time}
     1163    0.000    0.000    0.000    0.000 {built-in method unicodedata.east_asian_width}
        1    0.000    0.000    0.000    0.000 {function Random.seed at 0x7f469ef25620}
      ...
      409    0.000    0.000    0.000    0.000 {method 'acquire' of '_thread.RLock' objects}
   ...
   842607    0.049    0.000    0.049    0.000 {method 'append' of 'list' objects}
        1    0.000    0.000    0.000    0.000 {method 'copy' of 'dict' objects}
      100    0.000    0.000    0.000    0.000 {method 'copy' of 'list' objects}
    ...
    10120    0.002    0.000    0.002    0.000 {method 'endswith' of 'str' objects}
      ...
      206    0.005    0.000    0.005    0.000 {method 'flush' of '_io.TextIOWrapper' objects}
       22    0.000    0.000    0.000    0.000 {method 'format' of 'str' objects}
     1311    0.000    0.000    0.000    0.000 {method 'get' of 'dict' objects}
       ...
       25    0.000    0.000    0.000    0.000 {method 'match' of 're.Pattern' objects}
     6330    0.001    0.000    0.001    0.000 {method 'partition' of 'str' objects}
      ...
      409    0.000    0.000    0.000    0.000 {method 'release' of '_thread.RLock' objects}
        1    0.000    0.000    0.000    0.000 {method 'release' of '_thread.lock' objects}
        3    0.000    0.000    0.000    0.000 {method 'remove' of 'set' objects}
      604    0.000    0.000    0.000    0.000 {method 'rfind' of 'str' objects}
       ...
       20    0.000    0.000    0.000    0.000 {method 'span' of 're.Match' objects}
    73859    0.108    0.000    0.108    0.000 {method 'split' of 'str' objects}
        1    0.000    0.000    0.000    0.000 {method 'startswith' of 'bytes' objects}
     8663    0.002    0.000    0.002    0.000 {method 'startswith' of 'str' objects}
   830284    0.046    0.000    0.046    0.000 {method 'strip' of 'str' objects}
      ...
      214    0.000    0.000    0.000    0.000 {method 'write' of '_io.TextIOWrapper' objects}
