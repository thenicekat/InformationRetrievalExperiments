...
=============================================================
   156     78.6 MiB     78.6 MiB           1   @memory_profile
   157                                         def permuterm_trial():
   158    176.6 MiB     98.0 MiB           1       postings, term_freq = load_index_in_memory("./s2/")
   159                                             # Here postings is the inverted index
   160                                             # term_freq is the term frequency of each term in the collection
   161    254.6 MiB     78.0 MiB           1       permuterm_index = generate_permuterm_indices(term_freq=term_freq)
   162    254.8 MiB      0.2 MiB           1       permuterm_search_on_all_terms(permuterm_index, postings)


         24028208 function calls (24027059 primitive calls) in 27.116 seconds
   ...
   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
     ...
     4279    0.031    0.000    0.045    0.000 <frozen codecs>:319(decode)
     ...
     8716    0.003    0.000    0.005    0.000 <frozen posixpath>:41(_get_sep)
      ...
      775    0.013    0.000    0.049    0.000 <frozen posixpath>:421(_joinrealpath)
     ...
     6330    0.012    0.000    0.019    0.000 <frozen posixpath>:71(join)
       42    0.000    0.000    0.000    0.000 <string>:1(<lambda>)
        1    0.000    0.000   27.116   27.116 <string>:1(<module>)
       ...
       60    0.002    0.000    0.003    0.000 __init__.py:1561(findCaller)
    ...
    280/2    0.002    0.000    0.003    0.002 _compiler.py:37(_compile)
       ...
       62    0.000    0.000    0.000    0.000 _compiler.py:396(_simple)
        ...
        2    0.000    0.000    0.011    0.006 _compiler.py:738(compile)
   ...
   306/29    0.001    0.000    0.001    0.000 _parser.py:174(getwidth)
     ...
     52/2    0.001    0.000    0.008    0.004 _parser.py:449(_parse_sub)
    221/5    0.003    0.000    0.008    0.002 _parser.py:509(_parse)
       ...
       26    0.000    0.000    0.001    0.000 _parser.py:94(closegroup)
        ...
        2    0.000    0.000    0.008    0.004 _parser.py:972(parse)
        ...
        1    0.001    0.001   26.978   26.978 experiment4.py:156(permuterm_trial)
        1    1.114    1.114    1.124    1.124 experiment4.py:55(generate_permuterm_indices)
       30   19.300    0.643   23.215    0.774 experiment4.py:69(permuterm_search_on_one_term)
        1    0.003    0.003   23.286   23.286 experiment4.py:88(permuterm_search_on_all_terms)
        1    0.000    0.000    0.000    0.000 functools.py:393(__get__)
        1    0.000    0.000    0.000    0.000 functools.py:421(_unwrap_partial)
        1    0.000    0.000    0.076    0.076 inspect.py:1055(findsource)
        1    0.000    0.000    0.000    0.000 inspect.py:1172(__init__)
       42    0.000    0.000    0.000    0.000 inspect.py:1181(tokeneater)
        1    0.000    0.000    0.011    0.011 inspect.py:1224(getblock)
        1    0.000    0.000    0.087    0.087 inspect.py:1235(getsourcelines)
     1636    0.001    0.000    0.001    0.000 inspect.py:283(ismodule)
      ...
      776    0.003    0.000    0.010    0.000 inspect.py:936(getsourcefile)
     ...
     3008    0.001    0.000    0.001    0.000 inspect.py:946(<genexpr>)
      776    0.001    0.000    0.016    0.000 inspect.py:961(getabsfile)
        ...
        1    2.018    2.018    2.567    2.567 main.py:133(load_index_in_memory)
        1    0.000    0.000   27.116   27.116 memory_profiler.py:1185(wrapper)
        ...
        1    0.000    0.000    0.087    0.087 memory_profiler.py:645(add)
        ...
        1    0.000    0.000    0.087    0.087 memory_profiler.py:713(__call__)
        1    0.000    0.000    0.087    0.087 memory_profiler.py:728(add_function)
        ...
        1    0.051    0.051   27.029   27.029 memory_profiler.py:759(f)
       ...
       35    0.000    0.000    0.001    0.000 std.py:102(acquire)
       ...
       30    0.001    0.000    0.032    0.001 std.py:1198(update)
       ...
       31    0.000    0.000    0.031    0.001 std.py:1325(refresh)
       32    0.001    0.000    0.001    0.000 std.py:1446(format_dict)
       32    0.001    0.000    0.030    0.001 std.py:1464(display)
      ...
      181    0.001    0.000    0.001    0.000 std.py:231(__call__)
       ...
       32    0.005    0.000    0.019    0.001 std.py:464(format_meter)
       ...
       43    0.000    0.000    0.011    0.000 tokenize.py:433(_tokenize)
        1    0.000    0.000    0.000    0.000 tokenize.py:616(generate_tokens)
        1    0.000    0.000    0.010    0.010 tokenize.py:99(_compile)
      4/2    0.000    0.000    0.000    0.000 typing.py:3350(__getattribute__)
       ...
       96    0.000    0.000    0.016    0.000 utils.py:374(_text_width)
     ...
     4279    0.014    0.000    0.014    0.000 {built-in method _codecs.utf_8_decode}
     ...
     1552    0.001    0.000    0.004    0.000 {built-in method builtins.any}
      ...
      3/1    0.000    0.000   27.116   27.116 {built-in method builtins.exec}
...
150097/149787    0.025    0.000    0.025    0.000 {built-in method builtins.len}
    ...
    13676    0.002    0.000    0.002    0.000 {built-in method posix.fspath}
     ...
     6330    0.012    0.000    0.012    0.000 {built-in method posix.lstat}
     ...
     9294    0.001    0.000    0.001    0.000 {built-in method unicodedata.east_asian_width}
        1    0.000    0.000    0.000    0.000 {function Random.seed at 0x7f0500255580}
   ...
   833406    0.107    0.000    0.107    0.000 {method 'append' of 'list' objects}
    ...
    73759    0.277    0.000    0.277    0.000 {method 'split' of 'str' objects}
        1    0.000    0.000    0.000    0.000 {method 'startswith' of 'bytes' objects}
 21957473    3.905    0.000    3.905    0.000 {method 'startswith' of 'str' objects}
   830284    0.105    0.000    0.105    0.000 {method 'strip' of 'str' objects}
...
Line #    Mem usage    Increment  Occurrences   Line Contents
=============================================================
   165     95.0 MiB     95.0 MiB           1   @memory_profile
   166                                         def trie_trial():
   167    177.0 MiB     82.0 MiB           1       postings, term_freq = load_index_in_memory("./s2/")
   168                                             # Here postings is the inverted index
   169                                             # term_freq is the term frequency of each term in the collection
   170    305.6 MiB    128.6 MiB           2       trieBasedIndexFromStart, trieBasedIndexFromEnd = generate_trie_indices(
   171    177.0 MiB      0.0 MiB           1           term_freq=term_freq
   172                                             )
   173    313.9 MiB      8.3 MiB           2       tree_based_search(
   174    305.6 MiB      0.0 MiB           1           start_trie=trieBasedIndexFromStart,
   175    305.6 MiB      0.0 MiB           1           end_trie=trieBasedIndexFromEnd,
   176    305.6 MiB      0.0 MiB           1           postings=postings,
   177                                             )


         5949203 function calls (3280852 primitive calls) in 15.367 seconds
     ...
     4276    0.017    0.000    0.028    0.000 <frozen codecs>:319(decode)
      ...
      240    0.000    0.000    0.000    0.000 <frozen posixpath>:52(normcase)
       61    0.000    0.000    0.000    0.000 <string>:1(<lambda>)
        1    0.000    0.000   15.367   15.367 <string>:1(<module>)
       60    0.001    0.000    0.006    0.000 __init__.py:1087(flush)
       60    0.001    0.000    0.011    0.000 __init__.py:1098(emit)
       60    0.000    0.000    0.011    0.000 __init__.py:1216(emit)
       60    0.000    0.000    0.000    0.000 __init__.py:123(getLevelName)
      ...
      120    0.000    0.000    0.000    0.000 __init__.py:929(release)
       ...
       60    0.001    0.000    0.012    0.000 __init__.py:965(handle)
        ...
        1    0.000    0.000    0.000    0.000 decoder.py:332(decode)
        1    0.000    0.000    0.000    0.000 decoder.py:343(raw_decode)
        1    0.245    0.245    4.715    4.715 experiment4.py:103(generate_trie_indices)
        1    0.166    0.166    8.513    8.513 experiment4.py:126(tree_based_search)
       30    0.213    0.007    0.213    0.007 experiment4.py:143(<listcomp>)
        2    0.000    0.000    0.000    0.000 experiment4.py:16(__init__)
        1    0.002    0.002   15.198   15.198 experiment4.py:165(trie_trial)
   147518    2.610    0.000    4.471    0.000 experiment4.py:19(insert)
       60    0.001    0.000    8.083    0.135 experiment4.py:35(starts_with)
2668411/60    8.009    0.000    8.082    0.135 experiment4.py:47(dfs)
   516813    1.861    0.000    1.861    0.000 experiment4.py:9(__init__)
        1    0.000    0.000    0.000    0.000 functools.py:393(__get__)
        1    0.000    0.000    0.000    0.000 functools.py:421(_unwrap_partial)
       ...
       61    0.000    0.000    0.000    0.000 inspect.py:1181(tokeneater)
        ...
        2    0.000    0.000    0.000    0.000 linecache.py:36(getlines)
        1    0.000    0.000    0.000    0.000 linecache.py:52(checkcache)
        1    1.620    1.620    1.967    1.967 main.py:133(load_index_in_memory)
        1    0.000    0.000   15.367   15.367 memory_profiler.py:1185(wrapper)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:1201(choose_backend)
        6    0.000    0.000    0.000    0.000 memory_profiler.py:1215(<genexpr>)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:640(__init__)
        1    0.000    0.000    0.002    0.002 memory_profiler.py:645(add)
        2    0.000    0.000    0.000    0.000 memory_profiler.py:689(items)
       14    0.000    0.000    0.000    0.000 memory_profiler.py:695(<genexpr>)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:702(__init__)
        1    0.000    0.000    0.002    0.002 memory_profiler.py:713(__call__)
        1    0.000    0.000    0.002    0.002 memory_profiler.py:728(add_function)
        2    0.000    0.000    0.000    0.000 memory_profiler.py:740(_count_ctxmgr)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:748(wrap_function)
        1    0.167    0.167   15.365   15.365 memory_profiler.py:759(f)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:775(enable_by_count)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:782(disable_by_count)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:842(enable)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:849(disable)
       ...
       18    0.000    0.000    0.000    0.000 std.py:106(release)
        ...
        4    0.000    0.000    0.000    0.000 std.py:113(__exit__)
        1    0.000    0.000    0.000    0.000 std.py:1147(__del__)
       15    0.000    0.000    0.010    0.001 std.py:1150(__str__)
        2    0.000    0.000    0.000    0.000 std.py:1153(_comparable)
        2    0.000    0.000    0.000    0.000 std.py:1157(__hash__)
       31    0.000    0.000    0.016    0.001 std.py:1160(__iter__)
       13    0.000    0.000    0.014    0.001 std.py:1198(update)
        2    0.000    0.000    0.001    0.000 std.py:1265(close)
        2    0.000    0.000    0.000    0.000 std.py:1286(fp_write)
        1    0.000    0.000    0.000    0.000 std.py:1301(<lambda>)
       14    0.000    0.000    0.015    0.001 std.py:1325(refresh)
       15    0.000    0.000    0.000    0.000 std.py:1446(format_dict)
       15    0.000    0.000    0.015    0.001 std.py:1464(display)
       ...
       15    0.000    0.000    0.005    0.000 std.py:457(print_status)
       15    0.003    0.000    0.009    0.001 std.py:464(format_meter)
       ...
       62    0.000    0.000    0.001    0.000 tokenize.py:433(_tokenize)
        1    0.000    0.000    0.000    0.000 tokenize.py:616(generate_tokens)
       ...
       30    0.000    0.000    0.000    0.000 utils.py:273(_is_ascii)
        1    0.000    0.000    0.000    0.000 utils.py:282(_screen_shape_wrapper)
        1    0.000    0.000    0.000    0.000 utils.py:333(_screen_shape_linux)
       45    0.000    0.000    0.008    0.000 utils.py:374(_text_width)
     4396    0.005    0.000    0.006    0.000 utils.py:375(<genexpr>)
       45    0.000    0.000    0.008    0.000 utils.py:378(disp_len)
       15    0.000    0.000    0.004    0.000 utils.py:386(disp_trim)
     ...
     4276    0.010    0.000    0.010    0.000 {built-in method _codecs.utf_8_decode}
      120    0.000    0.000    0.000    0.000 {built-in method _thread.get_ident}
       ...
       73    0.000    0.000    0.000    0.000 {built-in method builtins.divmod}
        1    0.000    0.000   15.367   15.367 {built-in method builtins.exec}
    ...
    73915    0.011    0.000    0.011    0.000 {built-in method builtins.len}
      ...
      315    0.000    0.000    0.000    0.000 {built-in method builtins.ord}
       45    0.002    0.000    0.008    0.000 {built-in method builtins.sum}
        1    0.000    0.000    0.000    0.000 {built-in method fcntl.ioctl}
        1    0.000    0.000    0.000    0.000 {built-in method fromtimestamp}
      ...
      360    0.000    0.000    0.000    0.000 {built-in method posix.fspath}
       ...
       60    0.001    0.000    0.001    0.000 {built-in method time.localtime}
       60    0.000    0.000    0.000    0.000 {built-in method time.strftime}
      127    0.000    0.000    0.000    0.000 {built-in method time.time}
    ...
    43392    0.007    0.000    0.007    0.000 {method 'add' of 'set' objects}
  1571045    0.159    0.000    0.159    0.000 {method 'append' of 'list' objects}
        1    0.000    0.000    0.000    0.000 {method 'difference' of 'set' objects}
        1    0.000    0.000    0.000    0.000 {method 'disable' of '_lsprof.Profiler' objects}
        1    0.000    0.000    0.000    0.000 {method 'encode' of 'str' objects}
        2    0.000    0.000    0.000    0.000 {method 'end' of 're.Match' objects}
   ...
   830284    0.085    0.000    0.085    0.000 {method 'strip' of 'str' objects}
