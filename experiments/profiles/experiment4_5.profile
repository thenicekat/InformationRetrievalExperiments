...
=============================================================
   156     84.1 MiB     84.1 MiB           1   @memory_profile
   157                                         def permuterm_trial():
   158    182.0 MiB     98.0 MiB           1       postings, term_freq = load_index_in_memory("./s2/")
   159                                             # Here postings is the inverted index
   160                                             # term_freq is the term frequency of each term in the collection
   161    260.0 MiB     78.0 MiB           1       permuterm_index = generate_permuterm_indices(term_freq=term_freq)
   162    260.2 MiB      0.2 MiB           1       permuterm_search_on_all_terms(permuterm_index, postings)


         24028208 function calls (24027059 primitive calls) in 26.666 seconds
   ...
   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
     ...
     4279    0.027    0.000    0.041    0.000 <frozen codecs>:319(decode)
      ...
      3/1    0.000    0.000    0.003    0.003 <frozen importlib._bootstrap>:1120(_find_and_load_unlocked)
      3/1    0.000    0.000    0.003    0.003 <frozen importlib._bootstrap>:1165(_find_and_load)
      ...
      8/2    0.000    0.000    0.002    0.001 <frozen importlib._bootstrap>:233(_call_with_frames_removed)
       28    0.000    0.000    0.000    0.000 <frozen importlib._bootstrap>:244(_verbose_message)
        ...
        3    0.000    0.000    0.000    0.000 <frozen importlib._bootstrap>:566(module_from_spec)
      3/1    0.000    0.000    0.003    0.003 <frozen importlib._bootstrap>:666(_load_unlocked)
       ...
       10    0.000    0.000    0.000    0.000 <frozen importlib._bootstrap_external>:140(_path_stat)
        ...
        5    0.000    0.000    0.000    0.000 <frozen importlib._bootstrap_external>:1604(find_spec)
     ...
     1551    0.002    0.000    0.003    0.000 <frozen posixpath>:389(normpath)
     1551    0.002    0.000    0.010    0.000 <frozen posixpath>:397(abspath)
     8716    0.004    0.000    0.006    0.000 <frozen posixpath>:41(_get_sep)
      775    0.002    0.000    0.062    0.000 <frozen posixpath>:412(realpath)
      775    0.015    0.000    0.056    0.000 <frozen posixpath>:421(_joinrealpath)
     1016    0.001    0.000    0.001    0.000 <frozen posixpath>:52(normcase)
     2326    0.003    0.000    0.006    0.000 <frozen posixpath>:60(isabs)
     6330    0.014    0.000    0.022    0.000 <frozen posixpath>:71(join)
       42    0.000    0.000    0.000    0.000 <string>:1(<lambda>)
        1    0.000    0.000   26.666   26.666 <string>:1(<module>)
       60    0.001    0.000    0.006    0.000 __init__.py:1087(flush)
       60    0.001    0.000    0.010    0.000 __init__.py:1098(emit)
       ...
       60    0.001    0.000    0.012    0.000 __init__.py:1690(callHandlers)
      ...
      240    0.001    0.000    0.001    0.000 __init__.py:194(_is_internal_frame)
       60    0.001    0.000    0.025    0.000 __init__.py:2140(info)
        2    0.000    0.000    0.011    0.005 __init__.py:225(compile)
        1    0.000    0.000    0.000    0.000 __init__.py:228(_acquireLock)
        1    0.000    0.000    0.000    0.000 __init__.py:237(_releaseLock)
        2    0.000    0.000    0.011    0.005 __init__.py:272(_compile)
      ...
      120    0.000    0.000    0.000    0.000 __init__.py:929(release)
       ...
       59    0.000    0.000    0.001    0.000 _compiler.py:241(_optimize_charset)
       26    0.000    0.000    0.000    0.000 _compiler.py:31(_combine_flags)
    280/2    0.002    0.000    0.003    0.002 _compiler.py:37(_compile)
       ...
       62    0.000    0.000    0.000    0.000 _compiler.py:396(_simple)
        ...
        2    0.000    0.000    0.003    0.002 _compiler.py:571(_code)
        2    0.000    0.000    0.011    0.005 _compiler.py:738(compile)
   ...
   306/29    0.001    0.000    0.001    0.000 _parser.py:174(getwidth)
      ...
      667    0.000    0.000    0.001    0.000 _parser.py:254(get)
     ...
     52/2    0.001    0.000    0.007    0.004 _parser.py:449(_parse_sub)
    221/5    0.002    0.000    0.007    0.001 _parser.py:509(_parse)
       ...
       26    0.000    0.000    0.001    0.000 _parser.py:94(closegroup)
        ...
        2    0.000    0.000    0.007    0.004 _parser.py:972(parse)
        ...
        1    0.000    0.000    0.004    0.004 context.py:70(RLock)
        ...
        1    0.001    0.001   26.523   26.523 experiment4.py:156(permuterm_trial)
        1    1.108    1.108    1.114    1.114 experiment4.py:55(generate_permuterm_indices)
       30   19.065    0.636   23.013    0.767 experiment4.py:69(permuterm_search_on_one_term)
        1    0.003    0.003   23.077   23.077 experiment4.py:88(permuterm_search_on_all_terms)
        1    0.000    0.000    0.000    0.000 functools.py:393(__get__)
        1    0.000    0.000    0.000    0.000 functools.py:421(_unwrap_partial)
        1    0.000    0.000    0.089    0.089 inspect.py:1055(findsource)
        1    0.000    0.000    0.000    0.000 inspect.py:1172(__init__)
       42    0.000    0.000    0.000    0.000 inspect.py:1181(tokeneater)
        1    0.000    0.000    0.010    0.010 inspect.py:1224(getblock)
        1    0.000    0.000    0.099    0.099 inspect.py:1235(getsourcelines)
     1636    0.001    0.000    0.001    0.000 inspect.py:283(ismodule)
      ...
      825    0.001    0.000    0.002    0.000 inspect.py:896(getfile)
      776    0.003    0.000    0.013    0.000 inspect.py:936(getsourcefile)
     2328    0.001    0.000    0.001    0.000 inspect.py:943(<genexpr>)
     3008    0.001    0.000    0.002    0.000 inspect.py:946(<genexpr>)
      776    0.002    0.000    0.020    0.000 inspect.py:961(getabsfile)
        1    0.003    0.003    0.087    0.087 inspect.py:973(getmodule)
        ...
        1    1.866    1.866    2.330    2.330 main.py:133(load_index_in_memory)
        1    0.000    0.000   26.666   26.666 memory_profiler.py:1185(wrapper)
        ...
        1    0.000    0.000    0.099    0.099 memory_profiler.py:645(add)
        ...
        1    0.000    0.000    0.099    0.099 memory_profiler.py:713(__call__)
        1    0.000    0.000    0.099    0.099 memory_profiler.py:728(add_function)
        ...
        1    0.044    0.044   26.567   26.567 memory_profiler.py:759(f)
       ...
       32    0.001    0.000    0.018    0.001 std.py:1150(__str__)
        2    0.000    0.000    0.000    0.000 std.py:1153(_comparable)
        2    0.000    0.000    0.000    0.000 std.py:1157(__hash__)
        1    0.000    0.000    0.004    0.004 std.py:116(create_mp_lock)
       31    0.001    0.000    0.031    0.001 std.py:1160(__iter__)
       30    0.001    0.000    0.030    0.001 std.py:1198(update)
       ...
       31    0.000    0.000    0.028    0.001 std.py:1325(refresh)
       32    0.001    0.000    0.001    0.000 std.py:1446(format_dict)
       32    0.000    0.000    0.028    0.001 std.py:1464(display)
       ...
       32    0.000    0.000    0.000    0.000 std.py:186(__format__)
        3    0.000    0.000    0.000    0.000 std.py:226(__init__)
      181    0.001    0.000    0.001    0.000 std.py:231(__call__)
       63    0.000    0.000    0.001    0.000 std.py:400(format_interval)
       ...
       32    0.005    0.000    0.017    0.001 std.py:464(format_meter)
        1    0.000    0.000    0.004    0.004 std.py:663(__new__)
        ...
        1    0.000    0.000    0.004    0.004 std.py:760(get_lock)
        1    0.000    0.000    0.004    0.004 std.py:90(__init__)
       ...
       43    0.000    0.000    0.010    0.000 tokenize.py:433(_tokenize)
        1    0.000    0.000    0.000    0.000 tokenize.py:616(generate_tokens)
        1    0.000    0.000    0.009    0.009 tokenize.py:99(_compile)
      4/2    0.000    0.000    0.000    0.000 typing.py:3350(__getattribute__)
       ...
       96    0.000    0.000    0.014    0.000 utils.py:374(_text_width)
     9390    0.009    0.000    0.010    0.000 utils.py:375(<genexpr>)
       96    0.000    0.000    0.015    0.000 utils.py:378(disp_len)
       32    0.000    0.000    0.006    0.000 utils.py:386(disp_trim)
     ...
     4279    0.013    0.000    0.013    0.000 {built-in method _codecs.utf_8_decode}
     ...
     1552    0.002    0.000    0.005    0.000 {built-in method builtins.any}
      158    0.000    0.000    0.000    0.000 {built-in method builtins.divmod}
      3/1    0.000    0.000   26.666   26.666 {built-in method builtins.exec}
    ...
    14397    0.003    0.000    0.003    0.000 {built-in method builtins.isinstance}
        1    0.000    0.000    0.000    0.000 {built-in method builtins.iter}
150097/149787    0.020    0.000    0.020    0.000 {built-in method builtins.len}
     ...
     1062    0.000    0.000    0.000    0.000 {built-in method builtins.ord}
       ...
       96    0.004    0.000    0.014    0.000 {built-in method builtins.sum}
    ...
    13676    0.002    0.000    0.002    0.000 {built-in method posix.fspath}
     ...
     6330    0.013    0.000    0.013    0.000 {built-in method posix.lstat}
      739    0.002    0.000    0.002    0.000 {built-in method posix.stat}
     ...
     9294    0.001    0.000    0.001    0.000 {built-in method unicodedata.east_asian_width}
        1    0.000    0.000    0.000    0.000 {function Random.seed at 0x7f8a64aad580}
    ...
    43393    0.011    0.000    0.011    0.000 {method 'add' of 'set' objects}
        1    0.000    0.000    0.000    0.000 {method 'append' of 'collections.deque' objects}
   833406    0.097    0.000    0.097    0.000 {method 'append' of 'list' objects}
    ...
    10120    0.003    0.000    0.003    0.000 {method 'endswith' of 'str' objects}
      ...
      201    0.000    0.000    0.000    0.000 {method 'find' of 'bytearray' objects}
       ...
       94    0.004    0.000    0.004    0.000 {method 'flush' of '_io.TextIOWrapper' objects}
    ...
    73759    0.216    0.000    0.216    0.000 {method 'split' of 'str' objects}
        1    0.000    0.000    0.000    0.000 {method 'startswith' of 'bytes' objects}
 21957473    3.938    0.000    3.938    0.000 {method 'startswith' of 'str' objects}
   830284    0.097    0.000    0.097    0.000 {method 'strip' of 'str' objects}
...
Line #    Mem usage    Increment  Occurrences   Line Contents
=============================================================
   165    101.3 MiB    101.3 MiB           1   @memory_profile
   166                                         def trie_trial():
   167    183.2 MiB     82.0 MiB           1       postings, term_freq = load_index_in_memory("./s2/")
   168                                             # Here postings is the inverted index
   169                                             # term_freq is the term frequency of each term in the collection
   170    311.9 MiB    128.6 MiB           2       trieBasedIndexFromStart, trieBasedIndexFromEnd = generate_trie_indices(
   171    183.2 MiB      0.0 MiB           1           term_freq=term_freq
   172                                             )
   173    320.6 MiB      8.7 MiB           2       tree_based_search(
   174    311.9 MiB      0.0 MiB           1           start_trie=trieBasedIndexFromStart,
   175    311.9 MiB      0.0 MiB           1           end_trie=trieBasedIndexFromEnd,
   176    311.9 MiB      0.0 MiB           1           postings=postings,
   177                                             )


         5949878 function calls (3281527 primitive calls) in 14.688 seconds
   ...
   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
     ...
     4276    0.017    0.000    0.028    0.000 <frozen codecs>:319(decode)
       60    0.000    0.000    0.000    0.000 <frozen genericpath>:121(_splitext)
        2    0.000    0.000    0.000    0.000 <frozen genericpath>:16(exists)
       60    0.000    0.000    0.001    0.000 <frozen posixpath>:117(splitext)
       60    0.001    0.000    0.001    0.000 <frozen posixpath>:140(basename)
      ...
      240    0.000    0.000    0.000    0.000 <frozen posixpath>:52(normcase)
       61    0.000    0.000    0.000    0.000 <string>:1(<lambda>)
        1    0.000    0.000   14.688   14.688 <string>:1(<module>)
       60    0.001    0.000    0.006    0.000 __init__.py:1087(flush)
       60    0.001    0.000    0.011    0.000 __init__.py:1098(emit)
       60    0.000    0.000    0.011    0.000 __init__.py:1216(emit)
       60    0.000    0.000    0.000    0.000 __init__.py:123(getLevelName)
       60    0.001    0.000    0.026    0.000 __init__.py:1479(info)
       60    0.001    0.000    0.003    0.000 __init__.py:1561(findCaller)
       60    0.001    0.000    0.007    0.000 __init__.py:1595(makeRecord)
       60    0.001    0.000    0.025    0.000 __init__.py:1610(_log)
       60    0.000    0.000    0.014    0.000 __init__.py:1636(handle)
       60    0.000    0.000    0.000    0.000 __init__.py:164(<lambda>)
      ...
      240    0.001    0.000    0.001    0.000 __init__.py:194(_is_internal_frame)
       60    0.001    0.000    0.026    0.000 __init__.py:2140(info)
        ...
        1    0.000    0.000    0.000    0.000 __init__.py:274(load)
       60    0.004    0.000    0.007    0.000 __init__.py:292(__init__)
        1    0.000    0.000    0.000    0.000 __init__.py:299(loads)
       60    0.000    0.000    0.000    0.000 __init__.py:368(getMessage)
       60    0.000    0.000    0.000    0.000 __init__.py:432(usesTime)
       60    0.000    0.000    0.000    0.000 __init__.py:440(_format)
      ...
      120    0.000    0.000    0.000    0.000 __init__.py:929(release)
       ...
       60    0.001    0.000    0.012    0.000 __init__.py:965(handle)
        ...
        1    0.000    0.000    0.000    0.000 decoder.py:332(decode)
        1    0.000    0.000    0.000    0.000 decoder.py:343(raw_decode)
        1    0.200    0.200    3.946    3.946 experiment4.py:103(generate_trie_indices)
        1    0.184    0.184    8.503    8.503 experiment4.py:126(tree_based_search)
       30    0.218    0.007    0.218    0.007 experiment4.py:143(<listcomp>)
        2    0.000    0.000    0.000    0.000 experiment4.py:16(__init__)
        1    0.001    0.001   14.526   14.526 experiment4.py:165(trie_trial)
   147518    2.181    0.000    3.746    0.000 experiment4.py:19(insert)
       60    0.001    0.000    8.045    0.134 experiment4.py:35(starts_with)
2668411/60    7.970    0.000    8.044    0.134 experiment4.py:47(dfs)
   516813    1.565    0.000    1.565    0.000 experiment4.py:9(__init__)
        1    0.000    0.000    0.000    0.000 functools.py:393(__get__)
        1    0.000    0.000    0.000    0.000 functools.py:421(_unwrap_partial)
        1    0.000    0.000    0.000    0.000 inspect.py:1055(findsource)
        1    0.000    0.000    0.000    0.000 inspect.py:1172(__init__)
       61    0.000    0.000    0.000    0.000 inspect.py:1181(tokeneater)
        1    0.000    0.000    0.000    0.000 inspect.py:1224(getblock)
        ...
        2    0.000    0.000    0.000    0.000 linecache.py:36(getlines)
        1    0.000    0.000    0.000    0.000 linecache.py:52(checkcache)
        1    1.705    1.705    2.076    2.076 main.py:133(load_index_in_memory)
        1    0.000    0.000   14.688   14.688 memory_profiler.py:1185(wrapper)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:1201(choose_backend)
        6    0.000    0.000    0.000    0.000 memory_profiler.py:1215(<genexpr>)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:640(__init__)
       ...
       14    0.000    0.000    0.000    0.000 memory_profiler.py:695(<genexpr>)
        ...
        2    0.000    0.000    0.000    0.000 memory_profiler.py:740(_count_ctxmgr)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:748(wrap_function)
        1    0.161    0.161   14.687   14.687 memory_profiler.py:759(f)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:775(enable_by_count)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:782(disable_by_count)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:842(enable)
        1    0.000    0.000    0.000    0.000 memory_profiler.py:849(disable)
       ...
       19    0.000    0.000    0.000    0.000 std.py:102(acquire)
       19    0.000    0.000    0.000    0.000 std.py:106(release)
        4    0.000    0.000    0.000    0.000 std.py:110(__enter__)
        4    0.000    0.000    0.000    0.000 std.py:113(__exit__)
        1    0.000    0.000    0.000    0.000 std.py:1147(__del__)
       16    0.000    0.000    0.011    0.001 std.py:1150(__str__)
        2    0.000    0.000    0.000    0.000 std.py:1153(_comparable)
        2    0.000    0.000    0.000    0.000 std.py:1157(__hash__)
       31    0.000    0.000    0.019    0.001 std.py:1160(__iter__)
       14    0.001    0.000    0.017    0.001 std.py:1198(update)
        2    0.000    0.000    0.001    0.001 std.py:1265(close)
        2    0.000    0.000    0.000    0.000 std.py:1286(fp_write)
        1    0.000    0.000    0.000    0.000 std.py:1301(<lambda>)
       15    0.000    0.000    0.017    0.001 std.py:1325(refresh)
       16    0.000    0.000    0.000    0.000 std.py:1446(format_dict)
       16    0.000    0.000    0.017    0.001 std.py:1464(display)
       16    0.000    0.000    0.000    0.000 std.py:153(__init__)
       16    0.000    0.000    0.000    0.000 std.py:163(colour)
       16    0.000    0.000    0.000    0.000 std.py:167(colour)
       16    0.000    0.000    0.000    0.000 std.py:186(__format__)
        3    0.000    0.000    0.000    0.000 std.py:226(__init__)
       85    0.000    0.000    0.000    0.000 std.py:231(__call__)
       31    0.000    0.000    0.000    0.000 std.py:400(format_interval)
        1    0.000    0.000    0.000    0.000 std.py:438(status_printer)
       16    0.000    0.000    0.002    0.000 std.py:451(fp_write)
       16    0.000    0.000    0.006    0.000 std.py:457(print_status)
       16    0.003    0.000    0.011    0.001 std.py:464(format_meter)
       ...
       62    0.000    0.000    0.000    0.000 tokenize.py:433(_tokenize)
        1    0.000    0.000    0.000    0.000 tokenize.py:616(generate_tokens)
       16    0.000    0.000    0.000    0.000 utils.py:108(__init__)
       16    0.000    0.000    0.000    0.000 utils.py:112(__format__)
        1    0.000    0.000    0.000    0.000 utils.py:125(__eq__)
        2    0.000    0.000    0.000    0.000 utils.py:139(__getattr__)
        3    0.000    0.000    0.000    0.000 utils.py:152(wrapper_setattr)
        1    0.000    0.000    0.000    0.000 utils.py:156(__init__)
        2    0.000    0.000    0.000    0.000 utils.py:187(disable_on_exception)
       34    0.000    0.000    0.002    0.000 utils.py:194(inner)
        1    0.000    0.000    0.000    0.000 utils.py:213(__init__)
        2    0.000    0.000    0.000    0.000 utils.py:222(__eq__)
        1    0.000    0.000    0.000    0.000 utils.py:252(_is_utf)
        1    0.000    0.000    0.000    0.000 utils.py:266(_supports_unicode)
       32    0.000    0.000    0.001    0.000 utils.py:273(_is_ascii)
        1    0.000    0.000    0.000    0.000 utils.py:282(_screen_shape_wrapper)
        1    0.000    0.000    0.000    0.000 utils.py:333(_screen_shape_linux)
       48    0.000    0.000    0.009    0.000 utils.py:374(_text_width)
     4690    0.005    0.000    0.006    0.000 utils.py:375(<genexpr>)
       48    0.000    0.000    0.009    0.000 utils.py:378(disp_len)
       16    0.000    0.000    0.004    0.000 utils.py:386(disp_trim)
       62    0.000    0.000    0.000    0.000 {built-in method __new__ of type object at 0x860f60}
     4276    0.011    0.000    0.011    0.000 {built-in method _codecs.utf_8_decode}
      120    0.000    0.000    0.000    0.000 {built-in method _thread.get_ident}
       ...
       78    0.000    0.000    0.000    0.000 {built-in method builtins.divmod}
        1    0.000    0.000   14.688   14.688 {built-in method builtins.exec}
       14    0.000    0.000    0.000    0.000 {built-in method builtins.getattr}
      159    0.000    0.000    0.000    0.000 {built-in method builtins.hasattr}
        3    0.000    0.000    0.000    0.000 {built-in method builtins.id}
      179    0.000    0.000    0.000    0.000 {built-in method builtins.isinstance}
        1    0.000    0.000    0.000    0.000 {built-in method builtins.iter}
    73917    0.011    0.000    0.011    0.000 {built-in method builtins.len}
      ...
      336    0.000    0.000    0.000    0.000 {built-in method builtins.ord}
       48    0.002    0.000    0.008    0.000 {built-in method builtins.sum}
        1    0.000    0.000    0.000    0.000 {built-in method fcntl.ioctl}
        1    0.000    0.000    0.000    0.000 {built-in method fromtimestamp}
      ...
      360    0.000    0.000    0.000    0.000 {built-in method posix.fspath}
       ...
       60    0.001    0.000    0.001    0.000 {built-in method time.localtime}
       60    0.000    0.000    0.000    0.000 {built-in method time.strftime}
      131    0.000    0.000    0.000    0.000 {built-in method time.time}
     4642    0.001    0.000    0.001    0.000 {built-in method unicodedata.east_asian_width}
  ...
  1571045    0.168    0.000    0.168    0.000 {method 'append' of 'list' objects}
        1    0.000    0.000    0.000    0.000 {method 'difference' of 'set' objects}
        1    0.000    0.000    0.000    0.000 {method 'disable' of '_lsprof.Profiler' objects}
        1    0.000    0.000    0.000    0.000 {method 'encode' of 'str' objects}
        2    0.000    0.000    0.000    0.000 {method 'end' of 're.Match' objects}
       ...
       60    0.000    0.000    0.000    0.000 {method 'find' of 'str' objects}
       78    0.005    0.000    0.005    0.000 {method 'flush' of '_io.TextIOWrapper' objects}
       63    0.000    0.000    0.001    0.000 {method 'format' of 'str' objects}
    ...
    73819    0.146    0.000    0.146    0.000 {method 'split' of 'str' objects}
        1    0.000    0.000    0.000    0.000 {method 'startswith' of 'str' objects}
   830284    0.092    0.000    0.092    0.000 {method 'strip' of 'str' objects}
       48    0.000    0.000    0.000    0.000 {method 'sub' of 're.Pattern' objects}
       17    0.000    0.000    0.000    0.000 {method 'update' of 'dict' objects}
       95    0.002    0.000    0.002    0.000 {method 'write' of '_io.TextIOWrapper' objects}
