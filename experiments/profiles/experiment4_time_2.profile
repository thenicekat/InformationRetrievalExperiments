::> PART 3.4.1: PERMUTERM INDEX
         23869367 function calls (23869351 primitive calls) in 5.657 seconds
   ...
   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
     ...
     4276    0.003    0.000    0.008    0.000 <frozen codecs>:319(decode)
      ...
      3/1    0.000    0.000    0.001    0.001 <frozen importlib._bootstrap>:1120(_find_and_load_unlocked)
      ...
      8/2    0.000    0.000    0.001    0.000 <frozen importlib._bootstrap>:233(_call_with_frames_removed)
      ...
      2/1    0.000    0.000    0.001    0.001 <frozen importlib._bootstrap_external>:934(exec_module)
        1    0.009    0.009    5.657    5.657 <string>:1(<module>)
     ...
     1915    0.002    0.000    0.003    0.000 __init__.py:2140(info)
        ...
        1    0.014    0.014    5.649    5.649 experiment4.py:148(permuterm_trial)
        1    0.324    0.324    0.898    0.898 experiment4.py:55(generate_permuterm_indices)
       30    2.645    0.088    4.720    0.157 experiment4.py:72(permuterm_search_on_one_term)
        1    0.001    0.001    4.737    4.737 experiment4.py:86(permuterm_search_on_all_terms)
        1    0.000    0.000    0.000    0.000 functools.py:393(__get__)
        1    0.348    0.348    0.570    0.570 main.py:133(load_index_in_memory)
       ...
       31    0.001    0.000    0.013    0.000 std.py:1160(__iter__)
       30    0.001    0.000    0.012    0.000 std.py:1198(update)
       ...
       31    0.000    0.000    0.012    0.000 std.py:1325(refresh)
       32    0.000    0.000    0.000    0.000 std.py:1446(format_dict)
       32    0.000    0.000    0.011    0.000 std.py:1464(display)
      ...
      181    0.000    0.000    0.000    0.000 std.py:231(__call__)
       ...
       32    0.000    0.000    0.004    0.000 std.py:457(print_status)
     ...
     4276    0.005    0.000    0.005    0.000 {built-in method _codecs.utf_8_decode}
      ...
      3/1    0.000    0.000    5.657    5.657 {built-in method builtins.exec}
   ...
   149510    0.009    0.000    0.009    0.000 {built-in method builtins.len}
     ...
     9294    0.001    0.000    0.001    0.000 {built-in method unicodedata.east_asian_width}
        1    0.000    0.000    0.000    0.000 {function Random.seed at 0x7faeba108220}
   ...
   830288    0.048    0.000    0.048    0.000 {method 'append' of 'list' objects}
       ...
       66    0.000    0.000    0.001    0.000 {method 'format' of 'str' objects}
    ...
    73759    0.116    0.000    0.116    0.000 {method 'split' of 'str' objects}
 21948816    2.071    0.000    2.071    0.000 {method 'startswith' of 'str' objects}
...
::> PART 3.4.2: TREE BASED INDEX
         5904202 function calls (3235851 primitive calls) in 3.065 seconds
   ...
   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
        2    0.000    0.000    0.000    0.000 <frozen codecs>:260(__init__)
        2    0.000    0.000    0.000    0.000 <frozen codecs>:309(__init__)
     4276    0.002    0.000    0.007    0.000 <frozen codecs>:319(decode)
        1    0.061    0.061    3.065    3.065 <string>:1(<module>)
     1915    0.001    0.000    0.001    0.000 __init__.py:1479(info)
     1915    0.000    0.000    0.000    0.000 __init__.py:1734(isEnabledFor)
     1915    0.001    0.000    0.002    0.000 __init__.py:2140(info)
        ...
        1    0.000    0.000    0.000    0.000 decoder.py:332(decode)
        1    0.000    0.000    0.000    0.000 decoder.py:343(raw_decode)
        1    0.063    0.063    1.455    1.455 experiment4.py:121(tree_based_search)
       30    0.041    0.001    0.041    0.001 experiment4.py:138(<listcomp>)
        1    0.019    0.019    3.004    3.004 experiment4.py:153(trie_trial)
        2    0.000    0.000    0.000    0.000 experiment4.py:16(__init__)
   147518    0.331    0.000    0.974    0.000 experiment4.py:19(insert)
       60    0.000    0.000    1.344    0.022 experiment4.py:35(starts_with)
2668411/60    1.303    0.000    1.344    0.022 experiment4.py:47(dfs)
   516813    0.643    0.000    0.643    0.000 experiment4.py:9(__init__)
        1    0.033    0.033    1.530    1.530 experiment4.py:97(generate_trie_indices)
        1    0.000    0.000    0.000    0.000 functools.py:393(__get__)
        1    0.340    0.340    0.522    0.522 main.py:133(load_index_in_memory)
       ...
       12    0.000    0.000    0.000    0.000 std.py:106(release)
        ...
        2    0.000    0.000    0.000    0.000 std.py:1153(_comparable)
        2    0.000    0.000    0.000    0.000 std.py:1157(__hash__)
       31    0.000    0.000    0.003    0.000 std.py:1160(__iter__)
       ...
       17    0.000    0.000    0.000    0.000 std.py:400(format_interval)
        1    0.000    0.000    0.000    0.000 std.py:438(status_printer)
        9    0.000    0.000    0.000    0.000 std.py:451(fp_write)
        ...
        1    0.000    0.000    0.000    0.000 utils.py:156(__init__)
        2    0.000    0.000    0.000    0.000 utils.py:187(disable_on_exception)
       20    0.000    0.000    0.000    0.000 utils.py:194(inner)
        1    0.000    0.000    0.000    0.000 utils.py:213(__init__)
        2    0.000    0.000    0.000    0.000 utils.py:222(__eq__)
        1    0.000    0.000    0.000    0.000 utils.py:252(_is_utf)
        1    0.000    0.000    0.000    0.000 utils.py:266(_supports_unicode)
     ...
     2635    0.001    0.000    0.001    0.000 utils.py:375(<genexpr>)
       27    0.000    0.000    0.001    0.000 utils.py:378(disp_len)
        9    0.000    0.000    0.000    0.000 utils.py:386(disp_trim)
  ...
  1571043    0.089    0.000    0.089    0.000 {method 'append' of 'list' objects}
        1    0.000    0.000    0.000    0.000 {method 'difference' of 'set' objects}
        1    0.000    0.000    0.000    0.000 {method 'disable' of '_lsprof.Profiler' objects}
        1    0.000    0.000    0.000    0.000 {method 'encode' of 'str' objects}
        2    0.000    0.000    0.000    0.000 {method 'end' of 're.Match' objects}
       ...
       12    0.000    0.000    0.000    0.000 {method 'release' of '_thread.RLock' objects}
        3    0.000    0.000    0.000    0.000 {method 'remove' of 'set' objects}
    73819    0.076    0.000    0.076    0.000 {method 'split' of 'str' objects}
